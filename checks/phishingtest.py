...
# Function to load phishing domains from a given file. Returns a list of phishing domains.
...
# Function to load phishing links from a given file. Returns a list of phishing links.
...
if __name__ == "__main__":
    phishing_domains = load_phishing_domains('../keywords/phishing_domains.txt')
    phishing_links = load_phishing_links('../keywords/phishing_links.txt')
    
    # Example email_message object should be passed here
    email_message = None  # Replace with actual email message object

    if is_phishing_email(email_message, phishing_domains, phishing_links):
