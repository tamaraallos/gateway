...
def check_emails():
    ...
    print("\n",selected_email, "has been selected")
...
def perform_checks(email_path):
    while True:
        ...
        print("3. DMARC Check")
        print("4. DLP Check")
        print("5. Sensitive_Info Check")
        print("6. Phishing Check")
        print("7. Spam Check")
        print("8. Spoofing Check")
        print("9. All Checks")
        print("10. Approve Email")
        print("11. Decline Email")
        print("12. Go back to the previous menu")
        ...
        if choice == "1":
            ...
            subprocess.run([sys.executable, os.path.join(CHECKS_DIR, "dlp_patterns.py"), email_path])
        elif choice == "5":
            ...
            subprocess.run([sys.executable, os.path.join(CHECKS_DIR, "spoofing.py"), email_path])
        elif choice == "9":
            subprocess.run([sys.executable, os.path.join(CHECKS_DIR, "DKIM_check.py"), email_path])
            subprocess.run([sys.executable, os.path.join(CHECKS_DIR, "spf_check.py"), email_path])
            subprocess.run([sys.executable, os.path.join(CHECKS_DIR, "dmarc_check.py"), email_path])
...
def approve_email(email_path):
    ...
    # Encrypt the email
    subprocess.run([sys.executable, os.path.join(CHECKS_DIR, "encryption.py"), email_path])
